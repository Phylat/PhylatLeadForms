<template>
  <div>
    ...
    <step-form-generator v-model="formData" :schema="currentSchema" :stepButtons="stepButtons" :curStep="currentStep" @nextStep="next" @prevStep="prev" @submitForm="submit" @clickAction="clickAction" :currentOptions="currentOptions">
    </step-form-generator>
    {{formData}}
